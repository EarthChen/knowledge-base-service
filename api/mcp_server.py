...
Tools exposed (20 total):
  ...
  - wiki_get_tree, wiki_get_related, wiki_get_domain_overview, wiki_get_snapshot, wiki_find_implementing_modules: Business wiki tree, cross-refs, domain overview, compiled snapshot, domain→code module lookup
"""
...
from api.mcp_helpers import (
    ...
    _WIKI_MCP_DISPATCH_FALLBACK,
    _filter_graph_context_by_entity_type,
    _filter_semantic_matches_by_entity_type,
    _format_get_document_mcp,
    _format_list_documents_mcp,
    _mcp_error,
    _normalize_entity_type_arg,
    _resolve_repo_base_path,
)
...
class KnowledgeBaseMCPHandler(DocumentIndexerMixin):
