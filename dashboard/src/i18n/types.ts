...
export interface Translations {
  ...
  configSettings: {
    ...
    wikiGroupCore: string;
    wikiGroupKnowledgeQuality: string;
    ...
    fields: {
      ...
      fieldMcpServerEnabled: string;
      fieldFeedbackEnabled: string;
      fieldLintSchedulerEnabled: string;
      fieldAutoHealEnabled: string;
      fieldDeepResearchEnabled: string;
      fieldConceptMergingEnabled: string;
      fieldConceptExtractionEnabled: string;
      fieldBusinessFlowEnabled: string;
      fieldBusinessDomainEnabled: string;
      fieldConfidenceScoringEnabled: string;
      fieldContradictionDetectionEnabled: string;
      fieldSupersessionTrackingEnabled: string;
      fieldMemoryTiersEnabled: string;
